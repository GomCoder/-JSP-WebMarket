...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7">
				<form action="./processUpdateBook.jsp"  name="newBook"  method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="text" name="mpublisher" class="form-control" value="<%=rs.getString("b_publisher") %>" >
						</div>					
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="text" id="totalPages" name="totalPages" class="form-control" value="<%=rs.getLong("b_totalPages") %>" >
						</div>					
					</div>
					<div class="form-group row">
						<label class="col-sm-2">출판일</label>
						<div class="col-sm-3">
							<input type="text" id="releaseDate" name="releaseDate" class="form-control" value="<%=rs.getLong("b_releaseDate") %>" >
						</div>					
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-5">
							...
							<input type="radio" name="condition" value="Refurbished">기증 도서
						</div>					
					</div>
					<div class="form-group row">
